<template>
  <div v-if="modelValue">
    <el-row>
      ...
      <el-col v-if="modelValue?.firstFrameVideo" :span="12">
        <el-form-item :label-width="formLabelWidth" label="首页封面">
          <upload-file v-model:url="modelValue.firstFrameVideo" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-form-item
    ...
    <!-- 视频表单 -->
    <FormCreate
      v-if="showImageConfig && modelValue.multimediaType === 'video'"
      v-model="modelValue.videoConfig"
      :formList="videoConfigFormList"
    ></FormCreate>
